...
const CoinFlipPage = () => {
  ...
  const getWalletClient = useCallback(async () => {
    ...
    try {
      // The activeWalletInstance from context is now the signer object from Thirdweb's useSigner()
      // A Thirdweb signer typically has a .provider property which is an EIP-1193 provider.
