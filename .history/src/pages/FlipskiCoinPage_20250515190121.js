        ...
        <div className="grid-item">
          <h2 className="grid-item-title">About $FLIPSKI</h2>
            <ul className="grid-item-list">
                <li>Flipski is a community-driven meme coin designed for fast flips and high vibes.</li>
                <li>Built on a solid foundation, $FLIPSKI aims to reward early holders and encourage rapid growth.</li>
                <li>Join the Flip Army and ride the next big wave in crypto fun and fortune.</li>
            </ul>
            </div>
          <div className="grid-item">
