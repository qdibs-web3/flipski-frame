    ...
    <div className="flipski-coin-page-container">
      ...
      <div className="title-row">
        ...
        <div className="icon-buttons">
            ...
            <img src="/images/icon1.png" alt="Link 1" className="icon-button" />
            </a>
            <a href="https://example2.com" target="_blank" rel="noopener noreferrer">
            <img src="/images/icon2.png" alt="Link 2" className="icon-button" />
            </a>
        </div>
        </div>

        <p className="copyable-address" onClick={() => navigator.clipboard.writeText('0x349gdfd89eh9eht0eh09rth70rh7t07')}>
        0x349gdfd89eh9eht0eh09rth70rh7t07 (Click to copy)
        </p>
