  ...
  return (
    <div className="level-system" style={{ maxWidth: '560px', minWidth: '200px' }}> {/* Added minWidth: 200px */}
      ...
      <div style={{ 
        ...
        <span style={{fontSize: '12px', color: '#ffffff', minWidth: '20px'}}>{level}</span>
        ...
        <span style={{fontSize: '12px', color: '#ffffff', minWidth: '20px', textAlign: 'right'}}>{level < 100 ? level + 1 : 'MAX'}</span>
      </div>
