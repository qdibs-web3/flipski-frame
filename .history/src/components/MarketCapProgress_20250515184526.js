...
function MarketCapProgress() {
    ...
    useEffect(() => {
        const fetchMarketCap = async () => {
            try {
                ...
                const response = await fetch(`https://api.dexscreener.com/latest/dex/tokens/0x113f096983410479f133a16dac36ab42f2df7932` );
    ...
    const milestones = [
        { label: "MC Goal 1", value: 250000, icon: milestone1Icon },
        { label: "MC Goal 2", value: 1000000, icon: milestone2Icon },
        { label: "MC Goal 3", value: 1500000, icon: milestone3Icon },
    ];
